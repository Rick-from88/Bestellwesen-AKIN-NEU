...
async function seed() {
  ...
  try {
    ...
    await client.query(
      ...
      [1, 'Meyer GmbH', 'Anna Meyer', 'anna.meyer@meyer-gmbh.de', '+49 30 111222', 'Hauptstrasse 1', '10115', 'Berlin', 'Deutschland']
    );
    ...
    await client.query(
      ...
      ($1,$2,$3,$4,$5,$6,$7,$8,$9)
      ON CONFLICT (id) DO NOTHING`,
      [2, 'Schulz AG', 'Markus Schulz', 'm.schulz@schulz-ag.de', '+49 40 333444', 'Marktweg 5', '20095', 'Hamburg', 'Deutschland']
    );
    ...
    await client.query(
      ...
      ($1,$2,$3,$4,$5,$6,$7,$8,$9)
      ON CONFLICT (id) DO NOTHING`,
      [3, 'Bauer Handels', 'Clara Bauer', 'clara.bauer@bauerhandels.de', '+49 89 555666', 'Industriestr. 12', '80331', 'München', 'Deutschland']
    );
    ...
    await client.query(
      ...
      ($1,$2,$3,$4,$5,$6,$7,$8,$9)
      ON CONFLICT (id) DO NOTHING`,
      [4, 'Klein & Co', 'Peter Klein', 'p.klein@klein-co.de', '+49 221 777888', 'Luisenstr. 8', '50667', 'Köln', 'Deutschland']
    );
